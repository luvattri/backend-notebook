package com.backendnotebook.securityconfiguration.filter;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    private UserInfoService userInfoDetailsService;
    @Override
    ...
    @Autowired
    public void setUserInfoDetailsService(UserInfoService userInfoDetailsService) {
